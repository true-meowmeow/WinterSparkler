package obsolete.swing.core.dropper;
...
public class DropPanel extends JPanelCustom {
    ...
    private static final Border HOVER_BORDER = BorderFactory.createLineBorder(new Color(0x1E88E5), 2);
    ...
    public boolean isHoverBorderEnabled() {
        return hoverBorderEnabled;
    }
