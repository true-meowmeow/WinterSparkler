...
import core.main.config.GridProperties;
import core.main.config.ThemeProperties;
 ...
 */
public abstract class AbstractInnerGridPanel extends JPanel implements LayoutManager2, ComponentVisibility {
    ...
    public Dimension minimumLayoutSize(Container parent) {
        Insets in = parent.getInsets();
        int minRight = LayoutCurves.minRightWidth();
