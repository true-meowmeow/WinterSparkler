...
public class BasePanel extends JPanel {
    ...
    private static final LayoutType DEFAULT_TYPE = LayoutType.BORDER;

    // Конструкторы
    public BasePanel(LayoutType type, Axis axis, int hgap, int vgap, boolean clearBorder) {
