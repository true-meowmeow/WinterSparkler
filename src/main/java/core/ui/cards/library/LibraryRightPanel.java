...
import core.ui.layout.AbstractInnerGridPanel;
import core.ui.layout.LayoutCurves;
 ...
 */
public class LibraryRightPanel extends AbstractInnerGridPanel {

    private LibraryPanels.LibraryPlaylistPanel playlistPanel;
    private LibraryPanels.LibraryQueuePanel queuePanel;
    private LibraryPanels.LibraryPlayPanel playPanel;
    private LibraryPanels.LibraryCoverPanel coverPanel;

    LibraryRightPanel(LibraryPanels panelsManager) {
    ...
    protected void layoutPanels(int x, int y, int width, int height, int hTop, int hBottom) {
        int wRightTop = LayoutCurves.eval(width, LayoutCurves.RIGHT);
        int wLeftTop = Math.max(0, width - wRightTop);

        int wRightBottom = LayoutCurves.eval(width, LayoutCurves.RIGHT);
