...
import obsolete.swing.elements.pages.home.RightSideContentController;
...
public final class TitleMenuBar extends JMenuBar {      //todo поменять как работает, вынести логику отсюда
    ...
    private void styleSettingsButton(JButton button) {
        ...
        button.setPreferredSize(LayoutProperties.get().getTitleNavigationSettingsButton());
