package swing.elements.pages.githublink;
...
public class PageGithubLink extends JPanel {

    public PageGithubLink() {
    ...
    public void setVisible(boolean aFlag) {
        ...
        if (aFlag) {
            ...
            try {
                Desktop.getDesktop().browse(new URI(CoreProperties.get().appLink()));
                System.exit(1);
            } catch (IOException e) {
